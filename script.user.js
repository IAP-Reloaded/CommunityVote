...
// ==/UserScript==
 ...
 var observer = new MutationObserver(function(mutations) {
    mutations.forEach(function(mutation) {
        ...
        if(msg.includes('!cv version')) {
            sendMessage('[CommunityVote] This bot is running CommunityVote v0.13.');
		}
    });
 });
 observer.observe(target, {childList: true});
  ...
  $('.content').append('<script src='https://cdn.slaask.com/chat.js'></script><script> _slaask.init('ec7dcf5c1dfba970436c29ee27511dee');</script>');
